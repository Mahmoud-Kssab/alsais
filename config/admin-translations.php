...
return [
    ...
    'scanned_directories' => [
        ...
        // base_path('routes'), // uncomment if you have translations in your routes i.e. you have localized URLs
        base_path('core/brackets/admin-auth/src'),
        base_path('core/brackets/admin-auth/resources'),
        base_path('core/brackets/admin-ui/resources'),
        base_path('core/brackets/admin-translations/resources'),
    ],
