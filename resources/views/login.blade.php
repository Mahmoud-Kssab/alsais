...
@section('title', __('Alsaiss | Login'))
                ...
                <div class="card">
                    <div class="card-block">
                        <auth-user-form
                            ...
                            :data="{}"
                            inline-template>
                            <form class="form-horizontal" role="form" method="POST" @submit.prevent="onSubmit" action="{{ url('/login/check') }}" novalidate>
                                {{ csrf_field() }}
                                ...
                                <div class="auth-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit"  class="btn btn-primary btn-block"><i class="fa"></i> {{ trans('brackets/admin-auth::admin.login.button') }}</button>
                                    </div>
                                    <div class="form-group text-center">
                                        <a href="{{ url('/') }}" class="auth-ghost-link">{{ __('Create Account') }}</a>
                                    </div>
                                </div>
                            </form>
                        </auth-user-form>
