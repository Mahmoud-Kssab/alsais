            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-sm pull-right m-b-0 ml-2" href="{{ url('admin/users/export') }}" role="button"><i class="fa fa-file-excel-o"></i>&nbsp; {{ trans('admin.user.actions.export') }}</a>
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'job'">{{ trans('admin.user.columns.job') }}</th>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                        ...
                                        <td>@{{ item.name }}</td>
                                        <td><a :href="'tel:'+item.phone" class="badge badge-primary p-2"><i class="fa fa-phone"></i> {{__('Call')}}</a></td>
                                        <td><a :href="'mailto:'+item.email" target="_blank" class="badge badge-dark p-2"><i class="fa fa-envelope"></i> {{__('Email')}}</a></td>
                                        <td>@{{ item.job }}</td>
                                        <td>
